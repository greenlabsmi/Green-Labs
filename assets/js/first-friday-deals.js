(() => {
  ...
  onReady(() => {
    ...
    hub.innerHTML = `
      ...
      <div class="ff-deal-hub__copy">
        ...
        <div class="ff-deal-hub__all-deals" aria-label="All First Friday offers">
          ...
          <div><strong>BUY 2 GET 1 FREE</strong><span>True North</span></div>
          ...
          <div><strong>30% OFF</strong><span>Batch</span></div>
    ...
    style.textContent = `
      ...
      .ff-deal-hub__art{margin:0 0 1.15rem;min-width:0}.ff-deal-hub__art img{display:block;width:100%;height:auto;border-radius:16px;box-shadow:0 12px 28px rgba(16,42,32,.12)}
      ...
      @media(max-width:520px){.ff-first-friday-deal-hub{padding:.8rem;border-radius:16px}.ff-deal-hub__art img{border-radius:12px}.ff-deal-hub__all-deals{grid-template-columns:1fr}.ff-deal-hub__all-deals>div{padding:.66rem .7rem}.ff-deal-hub__cta{width:100%}}
    `;
